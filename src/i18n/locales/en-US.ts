...
const enUS: TranslationKeys = {
  ...
  'executionMode.affordance.ask': 'Default · no tools — switch to Danger for shell/tools',
  ...
  'executionMode.upgrade.body.general': 'Ask mode cannot run commands or tools. Switch to Plan for read-only investigation, or Danger to execute.',
