...
const lightTheme = {
  wrapperClassName: 'rounded-2xl border border-gray-200 bg-white p-4',
  titleClassName: 'text-gray-900',
  eyebrowClassName: 'text-gray-500',
  subtitleClassName: 'text-gray-600',
  badgeClassName: 'rounded-xl bg-white px-3 py-2 text-right text-xs text-gray-700 shadow-[inset_0_0_0_1px_rgba(0,0,0,0.06)]',
  directionBadgeClassName: 'rounded-full bg-white px-2.5 py-1 text-[11px] font-medium text-gray-600 shadow-[inset_0_0_0_1px_rgba(0,0,0,0.06)]',
  plotBg: '#ffffff',
  axisLine: '#e5e7eb',
  gridLine: '#f3f4f6',
  axisText: '#9ca3af',
  ...
  emptyBorder: '#e5e7eb',
  emptyText: '#9ca3af',
  legendTextClassName: 'text-gray-600',
