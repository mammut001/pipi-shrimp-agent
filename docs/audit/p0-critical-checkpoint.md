...
| **Open High in backlog JSON** | **1** (R7-06; INFRA-01 fixed 2026-09-17) |
...
| **Remaining risk** | Overlay stuck-on-error (R3-07) and closeWindow orphan CDP (R3-08) fixed 2026-09-17. |
| **Follow-up** | AG-05 split `browserAgentStore.ts`. |
...
| R7-04 | Security | `artifactDetector` no filter when `workDir` undefined ✅ Fixed 2026-09-17 |
| R7-06 | Security | `outputDir` unused in artifactDetector |
| R7-12 | Security | Telegram invoke / Rust handler parity ✅ Fixed 2026-09-17 |
| INFRA-01 | Test | `@testing-library/react` (+ jest-dom / user-event) ✅ Fixed 2026-09-17 |
...
| 9 | TOP-15-01 | **test: chat P0 session isolation regression** ✅ Fixed 2026-09-17 | `src/store/chat/__tests__/` | T-01 | Low | Guard fixed R1-01/02 |
| 9b | TOP-15-02 | **test: shell split ChatInput regression** ✅ Fixed 2026-09-17 | `src/components/__tests__/ChatBrowserWorkspaceShell.splitChatInput.test.tsx` | T-02 | Low | Guard fixed R1-03 split chat panel |
