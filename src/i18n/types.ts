...
export type TranslationKeys = {
  ...
  'autoresearch.tabs.ariaLabel': string;
  'autoresearch.tabs.selfImprove': string;
  'autoresearch.tabs.selfImproveSubtitle': string;
  'autoresearch.mode.mlExperiment': string;
  'autoresearch.mode.selfImprove': string;
  'autoresearch.preset.fast': string;
  'autoresearch.preset.standard': string;
  'autoresearch.preset.full': string;
  'autoresearch.preset.custom': string;
  'autoresearch.preset.fastDesc': string;
  'autoresearch.preset.standardDesc': string;
  'autoresearch.preset.fullDesc': string;
  'autoresearch.preset.customDesc': string;
  'autoresearch.verificationCommands': string;
  'autoresearch.addCommand': string;
  'autoresearch.removeCommand': string;
  'autoresearch.atLeastOneCommand': string;
