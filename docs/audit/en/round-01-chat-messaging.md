...
| R1-15 | P2 | `Chat.tsx` (deleted) vs shell | Questionnaire not filtered by sessionId (shell correct) | ✅ Obsolete/fixed (AG-19/#145 2026-09-22; shell already gates via `activeQuestionnaireSessionId`) |
