...
const enUS: TranslationKeys = {
  ...
  'autoresearch.tabs.ariaLabel': 'Setup mode',
  'autoresearch.tabs.selfImprove': 'Self-Improve',
  'autoresearch.tabs.selfImproveSubtitle': 'Analyze a repository and propose fixes via verification commands.',
  'autoresearch.mode.mlExperiment': 'ML Experiment',
  'autoresearch.mode.selfImprove': 'Repo Self-Improve',
  'autoresearch.preset.fast': 'Fast',
  'autoresearch.preset.standard': 'Standard',
  'autoresearch.preset.full': 'Full',
  'autoresearch.preset.custom': 'Custom',
  'autoresearch.preset.fastDesc': 'Build check only',
  'autoresearch.preset.standardDesc': 'Build + test + typecheck',
  'autoresearch.preset.fullDesc': 'Build + test + typecheck + lint',
  'autoresearch.preset.customDesc': 'Define your own commands',
  'autoresearch.verificationCommands': 'Verification Commands',
  'autoresearch.addCommand': 'Add command',
  'autoresearch.removeCommand': 'Remove',
  'autoresearch.atLeastOneCommand': 'At least one verification command is required in self-improve mode.',
  ...
  'autoresearch.selfImproveRepoPlaceholder': 'Path to the repository to improve (e.g. ~/projects/my-app)',
  'autoresearch.selfImproveRepoField': 'Repository to improve',
  'autoresearch.selfImproveWorkdirHint': 'Working directory stores run artifacts. Repository path is the codebase to analyze and improve.',
  'autoresearch.selfImproveCardGoal': 'Repository to improve',
  'autoresearch.selfImproveInfo': 'Self-improve mode analyzes the repository for issues and proposes fixes. Verification commands (build, test, typecheck) are used as evaluation signals instead of ML metrics.',
  ...
  'token.realConsumed': 'Real Consumed',
  'token.newInput': 'New Input',
  'token.cacheHit': 'Cache Hit',
  'token.cacheHitRate': 'Cache Hit Rate',
  'token.savedByCache': 'Saved by Cache',
  'token.cacheBreakdown': 'Cache breakdown',
