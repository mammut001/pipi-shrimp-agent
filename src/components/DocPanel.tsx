        ...
        >
          <div className="min-h-full sm:p-4">
            <DocumentDetailShell
              ...
              sidebar={(
                <DocumentMetadataSidebar
                  createdAt={selectedDoc.meta.created}
                  updatedAt={selectedDoc.meta.updated}
                  path={selectedDoc.meta.path}
                  tags={selectedDoc.meta.tags}
                />
              )}
            >
              <DocumentContentCard>
                <MarkdownDocumentPreview body={selectedDoc.body} />
              </DocumentContentCard>
            </DocumentDetailShell>
          </div>
        </div>,
