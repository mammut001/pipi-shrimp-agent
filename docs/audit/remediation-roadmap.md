...
| **Architecture** | AG-02 `loopEngine.ts` (**PR2a** preflight shipped 2026-09-17; **PR2b** iteration+metrics open), AG-05 `browserAgentStore.ts`, AG-10 `web.rs` splits |
...
| AG-02 | `src/services/autoresearch/loopEngine.ts` | 1538 | Extract preflight, iteration, metrics phases — **PR2a** preflight shipped 2026-09-17; **PR2b** iteration+metrics still open | Yes | Yes — PR2a/PR2b; aligns with R5-02 |
