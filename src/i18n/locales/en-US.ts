...
const enUS: TranslationKeys = {
  ...
  'autoresearch.tabs.conversational': 'Guided Bootstrap',
  'autoresearch.tabs.advanced': 'Manual Setup',
  ...
  'autoresearch.bootstrap.kicker': 'Guided Bootstrap',
  'autoresearch.bootstrap.title': 'Bootstrap AutoResearch from a conversation',
  'autoresearch.bootstrap.description': 'Clarify the goal, gather papers, lock baselines, scaffold the workdir, then hand off into the existing AutoResearch loop.',
  'autoresearch.bootstrap.emptyPrompt': 'Start with a natural-language goal or pick a quick-start opener.',
  'autoresearch.bootstrap.readyTitle': 'Ready to hand off',
  'autoresearch.bootstrap.started': 'AutoResearch started',
  'autoresearch.bootstrap.progressTitle': 'Bootstrap Progress',
  'autoresearch.bootstrap.step.goal.title': 'Goal',
  'autoresearch.bootstrap.step.goal.description': 'Clarify the research objective.',
  'autoresearch.bootstrap.step.papers.title': 'Papers',
  'autoresearch.bootstrap.step.papers.description': 'Collect and ground source papers.',
  'autoresearch.bootstrap.step.baselines.title': 'Baselines',
  'autoresearch.bootstrap.step.baselines.description': 'Lock one or more comparison baselines.',
  'autoresearch.bootstrap.step.metrics.title': 'Metrics',
  'autoresearch.bootstrap.step.metrics.description': 'Choose the primary success metric.',
  'autoresearch.bootstrap.step.scaffold.title': 'Scaffold',
  'autoresearch.bootstrap.step.scaffold.description': 'Create the starting workdir and files.',
  'autoresearch.bootstrap.step.ready.title': 'Ready',
  'autoresearch.bootstrap.step.ready.description': 'Handoff to the existing AutoResearch loop.',
  'autoresearch.bootstrap.card.reproduce.title': 'Reproduce a paper',
  'autoresearch.bootstrap.card.reproduce.opener': 'I want to reproduce a paper end-to-end. Help me choose the goal, papers, baselines, metric, and starter scaffold.',
  'autoresearch.bootstrap.card.baseline.title': 'Beat a baseline',
  'autoresearch.bootstrap.card.baseline.opener': 'I want to beat a baseline on a known task. Propose the goal, keep the comparison honest, and scaffold the experiment workspace.',
  'autoresearch.bootstrap.card.ablation.title': 'Ablation study',
  'autoresearch.bootstrap.card.ablation.opener': 'I want to run an ablation study on an existing method. Help me lock the question, metrics, and an experiment scaffold.',
  'autoresearch.bootstrap.card.scratch.title': 'From scratch',
  'autoresearch.bootstrap.card.scratch.opener': 'I want to start a new AutoResearch project from scratch. Propose a concrete research goal and bootstrap the workspace.',
  'autoresearch.bootstrap.referenceDocsTitle': 'Literature & Reference Documents',
  'autoresearch.bootstrap.addReference': 'Add Reference Files',
  'autoresearch.bootstrap.noReference': 'No reference files attached yet. Drop or select PDF/code files.',
  'autoresearch.bootstrap.iterations': 'Iterations:',
  'autoresearch.bootstrap.start': 'Start AutoResearch',
  ...
  'autoresearch.bootstrap.statusStopped': 'Stopped',
  'autoresearch.bootstrap.statusFailed': 'Failed',
  'autoresearch.bootstrap.statusFinished': 'Finished',
  'autoresearch.bootstrap.statusIncomplete': 'Incomplete',
  'autoresearch.bootstrap.statusNeedsConfirmation': 'Needs Confirmation',
  'autoresearch.bootstrap.needsConfirmationTitle': 'Plan Needs Confirmation',
  'autoresearch.bootstrap.initializing': 'Initializing bootstrap process...',
  'autoresearch.bootstrap.streamingLogs': 'Streaming logs...',
  'autoresearch.recipe.title': 'Configure Research Recipe',
  'autoresearch.recipe.currentTemplate': 'Current Template',
  'autoresearch.recipe.confirmReset': 'Switching templates will overwrite your edited configurations. Are you sure you want to reset the recipe?',
  'autoresearch.recipe.researchGoal': 'Research Goal',
  'autoresearch.recipe.references': 'References',
  'autoresearch.recipe.baselineAndMetric': 'Baseline & Metric',
  'autoresearch.recipe.workspace': 'Workspace',
  'autoresearch.recipe.verification': 'Verification',
  'autoresearch.recipe.outputContract': 'Output Contract',
  'autoresearch.recipe.completed': 'Completed',
  'autoresearch.recipe.missing': 'Missing',
  'autoresearch.recipe.optional': 'Optional',
  'autoresearch.recipe.edit': 'Edit',
  'autoresearch.recipe.collapse': 'Collapse',
  'autoresearch.recipe.previewPrompt': 'Preview Start Prompt',
  'autoresearch.recipe.startScaffolding': 'Start Scaffold Generation',
  'autoresearch.recipe.missingWorkspace': 'Workspace is missing',
  'autoresearch.recipe.missingGoal': 'Research Goal is missing',
  'autoresearch.recipe.missingMetric': 'Primary metric is missing',
  'autoresearch.recipe.ready': 'Ready',
  'autoresearch.recipe.selectTemplateTitle': 'Select Template Preset',
  'autoresearch.recipe.collapseTemplate': 'Collapse Template Selection',
  'autoresearch.recipe.changeTemplate': 'Change Template',
  'autoresearch.recipe.requiredProgress': 'Required Items',
  'autoresearch.recipe.recipeProgress': 'Recipe Items',
  'autoresearch.recipe.targetMetric': 'Target Metric',
  'autoresearch.recipe.workspaceRoot': 'Workspace Root',
  'autoresearch.recipe.scaffoldFolder': 'Scaffold Folder',
  'autoresearch.recipe.todoItems': 'Todo Items',
  'autoresearch.recipe.agentProfileTitle': 'Bootstrap Agent Profile',
  'autoresearch.recipe.agentProfileDesc': 'Runs in headless session with restricted tool set.',
  'autoresearch.recipe.advancedTitle': 'Advanced: Prompt Blocks',
  'autoresearch.recipe.advancedDesc': 'Normally not needed. Used to manually tune the final start prompt.',
  'autoresearch.recipe.action.fillGoal': 'First enter research goal',
  'autoresearch.recipe.action.fillMetric': 'First enter primary metric',
  'autoresearch.recipe.action.selectWorkspace': 'First select workspace',
  'autoresearch.recipe.goalPlaceholder': 'Summarize the core target and scope of the experiment...',
  'autoresearch.recipe.goalLabel': 'Goal Description',
  'autoresearch.recipe.taskType': 'Task Type',
  'autoresearch.recipe.taskType.reproduce': 'Reproduce paper',
  'autoresearch.recipe.taskType.baseline': 'Beat baseline',
  'autoresearch.recipe.taskType.ablation': 'Ablation',
  'autoresearch.recipe.taskType.scratch': 'From scratch',
  'autoresearch.recipe.taskType.reproduceDesc': 'Guide the agent to duplicate paper claimed metrics.',
  'autoresearch.recipe.taskType.baselineDesc': 'Instruct the agent to search for methods to beat target scores.',
  'autoresearch.recipe.taskType.ablationDesc': 'Isolate specific features/parameters to observe degradation.',
  'autoresearch.recipe.taskType.scratchDesc': 'Start an exploratory greenfield implementation.',
  'autoresearch.recipe.selectFiles': 'Select and Add Files',
  'autoresearch.recipe.noFiles': 'No reference files attached yet.',
  'autoresearch.recipe.metricName': 'Primary Metric Name',
  'autoresearch.recipe.metricPlaceholder': 'e.g. accuracy, loss, f1',
  'autoresearch.recipe.direction': 'Optimization Direction',
  'autoresearch.recipe.direction.higher': 'Higher is Better (e.g. Accuracy)',
  'autoresearch.recipe.direction.lower': 'Lower is Better (e.g. Loss/Latency)',
  'autoresearch.recipe.baselineValue': 'Baseline Value (Optional)',
  'autoresearch.recipe.baselinePlaceholder': 'e.g. 0.85',
  'autoresearch.recipe.successCriteria': 'Success Criteria (Optional)',
  'autoresearch.recipe.successPlaceholder': 'e.g. Beating paper baseline of 0.88',
  'autoresearch.recipe.targetProfileMode': 'Target Profile Mode',
  'autoresearch.recipe.localMode': 'Local Project Directory',
  'autoresearch.recipe.remoteMode': 'SSH Remote Connection',
  'autoresearch.recipe.hostUser': 'Host: {host}:{port} (User: {user})',
  'autoresearch.recipe.rootDir': 'Root Directory Path',
  'autoresearch.recipe.rootDirPlaceholder': 'Enter directory path, e.g. /path/to/workdir',
  'autoresearch.recipe.rootDirEmpty': '⚠️ Target directory path cannot be empty',
  'autoresearch.recipe.folderNameEmpty': '⚠️ Folder name is required',
  'autoresearch.recipe.scaffoldFolderLabel': 'Scaffold Folder Name',
  'autoresearch.recipe.scaffoldPlaceholder': 'e.g. experiment-run',
  'autoresearch.recipe.addCommandPlaceholder': 'e.g. pytest tests/test_model.py',
  'autoresearch.recipe.addButton': 'Add',
  'autoresearch.recipe.noCommands': 'No verification commands specified. The agent will discover test files automatically.',
  'autoresearch.recipe.output.metrics': 'Include Evaluation Metrics',
  'autoresearch.recipe.output.artifacts': 'Include Created/Modified Artifacts',
  'autoresearch.recipe.output.commands': 'Include Command Execution Log',
  'autoresearch.recipe.output.failure': 'Include Detailed Failure Diagnostics',
  'autoresearch.recipe.output.risks': 'Include Remaining Risks / Future Directives',
  'autoresearch.recipe.output.metricsShort': 'metrics',
  'autoresearch.recipe.output.artifactsShort': 'artifacts',
  'autoresearch.recipe.output.commandsShort': 'commands',
  'autoresearch.recipe.output.failureShort': 'failure reason',
  'autoresearch.recipe.output.risksShort': 'remaining risks',
  'autoresearch.recipe.copyPrompt': 'Copy Prompt',
  'autoresearch.recipe.copied': 'Copied! ✓',
  'autoresearch.recipe.close': 'Close',
  'autoresearch.recipe.workspaceRootSummary': 'Workspace Root',
  'autoresearch.recipe.workspaceRootMissing': 'Not Selected',
  'autoresearch.recipe.templateDefault': 'Template Default',
  ...
  'autoresearch.recipe.fillMetricFirst': 'Fill primary metric first',
  'autoresearch.recipe.metricSummary': 'Primary metric: {metric}, {direction}, current baseline {baseline}',
  'autoresearch.recipe.workspaceSummary': 'Workspace root: {rootDir} · Scaffold directory: {scaffoldDir}',
  'autoresearch.recipe.outputSummary': 'Final report contains: {items}',
  'autoresearch.recipe.referenceGuidance.reproduce': 'Recommended: add paper PDF, README, or repository description.',
  'autoresearch.recipe.referenceGuidance.baseline': 'Recommended: add baseline logs, metrics tables, or paper links.',
  'autoresearch.recipe.referenceGuidance.ablation': 'Recommended: add model config, experiment logs, or ablation tables.',
  'autoresearch.recipe.referenceGuidance.scratch': 'Optional: add relevant papers or existing code for inspiration.',
  ...
  'autoresearch.manual.advancedFieldsHelper': 'Usually no need to modify. Used to override default paths, debug parameters, or maintain compatibility with older configurations.',
  'autoresearch.manual.finalBlocker': 'All configurations filled, the final step is to test the runtime environment.',
  'autoresearch.manual.summaryRuntimeTarget': 'Runtime Target',
  'autoresearch.manual.summaryWorkspaceDir': 'Workspace Directory',
  'autoresearch.manual.summaryTargetProject': 'Target Project',
  'autoresearch.manual.summaryPrimaryMetric': 'Primary Metric',
  'autoresearch.manual.summaryModelApi': 'Model API',
  'autoresearch.manual.summaryEnvCheck': 'Environment Check',
  'autoresearch.manual.modelConfigured': 'Configured (Ready)',
  'autoresearch.manual.modelNotConfigured': 'Not Configured (Missing)',
  'autoresearch.manual.envCheckPassed': 'Passed',
  'autoresearch.manual.envCheckFailed': 'Failed',
  'autoresearch.manual.envCheckNotTested': 'Not Tested',
  'autoresearch.manual.launchReadyHint': 'Review summary and start when ready',
  'autoresearch.manual.envCheckDesc': 'AutoResearch needs to verify that target paths are accessible and the runtime environment is compatible. Click below to test.',
  'autoresearch.manual.primaryMetricLabel': 'Primary Metric Name',
  'autoresearch.manual.directionLower': 'Lower is better',
  'autoresearch.manual.directionHigher': 'Higher is better',
  'autoresearch.manual.baselineOptional': 'Current Baseline (Optional)',
  'autoresearch.manual.maxIterationsLabel': 'Max Iterations',
  'autoresearch.manual.localEnvNote': 'Local execution supports macOS and Linux. On Windows, set Shell profile to WSL.',
  'autoresearch.manual.hostLabel': 'Host',
  'autoresearch.manual.userLabel': 'User',
  'autoresearch.manual.portLabel': 'Port',
  'autoresearch.manual.passwordLabel': 'Password',
  'autoresearch.manual.keyPathLabel': 'Key Path',
  ...
  'autoresearch.setupDescription': 'Run the loop locally on this machine or on a remote machine via SSH. On Windows, local runs require the WSL shell profile. Password auth requires sshpass.',
  'autoresearch.modeLocal': 'Local',
  'autoresearch.modeRemote': 'Remote SSH (Linux)',
  'autoresearch.hostPlaceholder': 'e.g. 192.168.1.10 or server.example.com',
  'autoresearch.userPlaceholder': 'e.g. ubuntu / root / your-user',
  'autoresearch.portPlaceholder': '22',
  'autoresearch.authAgent': 'SSH Agent / ~/.ssh/config',
  'autoresearch.authPassword': 'Password',
  'autoresearch.authKey': 'Key File',
  'autoresearch.authHelper': 'Supports SSH Agent forwarding, passwords, or private key files. Passwords are never saved.',
  ...
  'autoresearch.connectionStatusNeedsTestTitle': 'Connection test still needed',
  'autoresearch.connectionStatusTestingTitle': 'Checking the target environment',
  'autoresearch.connectionStatusTestingBody': 'We are verifying the provider, workdir, and experiment path now.',
  'autoresearch.connectionStatusSuccessTitle': 'Connection test passed',
  'autoresearch.connectionStatusSuccessBody': 'The current setup is ready to launch AutoResearch.',
  'autoresearch.connectionStatusErrorTitle': 'Connection test failed',
  'autoresearch.connectionStatusErrorBody': 'Fix the reported issue, then run the connection test again before starting.',
  'autoresearch.connectionStatusRawOutput': 'Show raw output',
  'autoresearch.connection.detailsTitle': 'Environment check details',
  'autoresearch.connection.osLabel': 'OS',
  'autoresearch.connection.gitLabel': 'Git repo',
  'autoresearch.connection.pwdLabel': 'pwd',
  'autoresearch.connection.gitOk': 'Yes',
  'autoresearch.connection.gitMissingWarning': 'Not a repo yet',
  'autoresearch.connection.gitNotInstalled': 'Git not installed',
  'autoresearch.connection.gitUnknown': 'Unknown',
  'autoresearch.connection.gitWillInit': 'Start will initialize Git in the target project. You do not need a repo for this check to pass.',
  'autoresearch.connection.experimentMissingWarning': 'Target project directory was not found. Create it or pick an existing folder before Start.',
  ...
  'autoresearch.check.connectionTest': 'Connection test',
  ...
  'autoresearch.workdirHelper': 'PiPi Output Folder for AutoResearch — stores run artifacts, logs, and metrics. Independent from the experiment repo.',
  'autoresearch.experimentDirHelper': 'Project Folder / target repo — must contain run_experiment.py and AUTORESEARCH.md.',
  ...
  'autoresearch.runHistoryTitle': 'Run History',
  'autoresearch.runHistoryHelper': 'Pick up the active run quickly, or jump back into an older experiment with a clearer summary.',
  'autoresearch.newRun': 'New Run',
  'autoresearch.badgeActive': 'Active',
  'autoresearch.deleteConfirm': 'Are you sure you want to delete this run? This action cannot be undone.',
  'autoresearch.batchDelete': 'Delete Selected',
  'autoresearch.batchDeleteConfirm': 'Are you sure you want to delete {count} selected run(s)? This action cannot be undone.',
  'autoresearch.selectedCount': '{count} selected',
  'autoresearch.exitSelect': 'Exit Selection',
  ...
  'autoresearch.iterationProgress': 'Iteration {current} / {total}',
  'autoresearch.phase.preflight': 'Preflight',
  'autoresearch.phase.init': 'Initializing',
  'autoresearch.phase.read_context': 'Reading Context',
  'autoresearch.phase.plan_hypothesis': 'Planning Hypothesis',
  'autoresearch.phase.edit_code': 'Editing Code',
  'autoresearch.phase.run_experiment': 'Running Experiment',
  'autoresearch.phase.parse_metrics': 'Parsing Metrics',
  'autoresearch.phase.reflect': 'Reflecting',
  ...
  'autoresearch.debug.copyRawEvents': 'Copy events',
  'autoresearch.debug.copyRawConversation': 'Copy conversation',
  ...
  'terminal.shell.wslMixedPathWarning': 'This terminal is using WSL, but the current path still looks like a Windows path. Avoid mixing WSL and PowerShell builds in the same workspace.',
  'terminal.shell.wslReady': 'WSL workspace',
  ...
  'chat.send': 'Send',
  'chat.stop': 'Stop',
  'chat.stopStreaming': 'Stop generating',
  'chat.stopTools': 'Stop tools',
  ...
  'chat.workspacePreviewTab': 'Workspace',
  ...
  'chat.changeWorkDirectory': 'Change folder',
  'chat.removeWorkDirectory': 'Remove folder',
  'chat.blockComposerTitle': 'Block Composer',
  'chat.blockComposerSubtitle': 'Assemble structured task blocks instead of writing custom prompts',
  'chat.loadPreset': 'Load Preset Template...',
  'chat.blockComposerToggle': 'Toggle Block Composer',
  'chat.useAsMessage': 'Use as message',
  'chat.sendTask': 'Send task',
  'chat.clearComposer': 'Clear',
  'chat.addBlock': 'ADD BLOCK:',
  'chat.canvasEmpty': 'Canvas is empty. Select a preset template above or click any button below to add custom task blocks.',
  'chat.moveUp': 'Move Up',
  'chat.moveDown': 'Move Down',
  'chat.removeBlock': 'Remove Block',
  'chat.blockLabel.intent': 'Intent',
  'chat.blockLabel.context': 'Context',
  'chat.blockLabel.mode': 'Mode',
  'chat.blockLabel.constraints': 'Constraints',
  'chat.blockLabel.output': 'Output',
  'chat.blockLabel.verification': 'Verification',
  'chat.blockLabel.safety': 'Safety',
  'chat.composerLabel': 'Composer',
  'chat.binding': 'Setting up...',
  // Two-folder model — Project Folder (the user's repo).
  'chat.projectFolder': 'Project Folder',
  'chat.projectFolderTooltip': 'Your actual project / repo. Tools run commands and read / write project files here.',
  'chat.setProjectFolder': 'Set project folder',
  'chat.noProjectFolderHint': 'No Project Folder is bound — workspace tools won\'t run until you pick one.',
  'chat.selectProjectFolderDialog': 'Select Project Folder',
  'chat.folderDialogBusy': 'A folder picker is already open. Close it, then try again.',
  'chat.folderDialogFailed': 'Could not open the folder picker.',
  // Two-folder model — PiPi Output Folder (app-owned output root).
  'chat.pipiOutputFolder': 'PiPi Output Folder',
  'chat.pipiOutputFolderTooltip': 'App-owned output root. Stores generated docs, memory, chat outputs, and AutoResearch artifacts.',
  'chat.setPipiOutputFolder': 'Set output folder',
  'chat.noPipiOutputFolderHint': 'No output folder set — using the app-managed default location.',
  'chat.selectPipiOutputFolderDialog': 'Select PiPi Output Folder',
  'chat.openPipiOutputFolder': 'Open output folder',
  'chat.contextFiles': 'Context Files',
  'chat.contextFileExternal': 'External reference',
  'chat.contextFileInsideWorkspace': 'Inside project folder',
  'chat.contextFileSetAsWorkspace': 'Set parent folder as the Project Folder?',
  'chat.useAsWorkspace': 'Use as Project Folder',
  ...
  'executionMode.ask.description': 'Chat only. No tool calls. Switch to Plan to inspect files, or Danger to execute.',
  'executionMode.ask.defaultBadge': 'Default',
  'executionMode.affordance.ask': 'Default · tools blocked — switch to Danger for shell/tools',
  'executionMode.affordance.plan': 'Read-only tools · Danger needed for shell/writes',
  'executionMode.affordance.danger': 'Tools/shell active · risky ops still confirm',
  'executionMode.affordance.switchToDanger': 'Switch to Danger',
  'executionMode.upgrade.title': 'This request needs tools',
  'executionMode.upgrade.body.browser': 'Ask mode cannot use the browser or run tools. Switch to Plan for read-only investigation, or Danger to execute.',
  'executionMode.upgrade.body.workspace': 'Ask mode cannot read project files or run tools. Switch to Plan to inspect the workspace, or Danger to make changes.',
  'executionMode.upgrade.body.general': 'Commands and shell tools require Danger mode. Ask mode cannot run tools, and Plan is read-only. Switch to Danger to execute, or Plan for read-only investigation.',
  'executionMode.upgrade.recommendDanger': 'Recommended for shell/tools',
  'executionMode.upgrade.agentButton': 'Switch to Plan & continue',
  'executionMode.upgrade.bypassButton': 'Switch to Danger',
  'executionMode.upgrade.cancel': 'Cancel',
  'executionMode.upgrade.switchedToAgent': 'Switched to Plan mode. Continuing…',
  'executionMode.upgrade.switchedToBypass': 'Switched to Danger mode. Continuing…',
  'executionMode.upgrade.hint': 'Plan can inspect read-only. Danger can execute with the full tool surface. Risky actions still need approval, and destructive actions are double-checked.',
  'executionMode.upgrade.switchedToPlan': 'Switched to Plan mode. Continuing…',
  'executionMode.upgrade.switchedToDanger': 'Switched to Danger mode. Continuing…',
  'executionMode.plan.label': 'Plan',
  'executionMode.plan.description': 'Inspect code read-only and produce a structured plan. The app saves valid plans automatically. No edits, shell, or browser.',
  ...
  'executionMode.agent.description': 'Default autonomous mode. Reads, edits, runs tests. Risky actions still ask for approval.',
  'executionMode.bypass.label': 'Danger',
  'executionMode.bypass.description': 'Full tool access with risky-action approvals and destructive-operation double-checks.',
  'executionMode.bypass.warningTitle': 'Enable Danger?',
  'executionMode.bypass.warningBody': 'Danger enables shell and the full tool surface for this session. New sessions still default to Ask (no tools). Risky operations still need approval — this is not legacy Bypass auto-approve — and destructive actions must be double-checked before execution.',
  'executionMode.bypass.warningConfirm': 'Enable Danger',
  'executionMode.bypass.warningCancel': 'Cancel',
  'executionMode.danger.label': 'Danger',
  'executionMode.danger.description': 'Full tool access with risky-action approvals and destructive-operation double-checks.',
  'executionMode.danger.badge': 'Danger',
  'executionMode.danger.warningTitle': 'Enable Danger?',
  'executionMode.danger.warningBody': 'Danger enables shell and the full tool surface for this session. New sessions still default to Ask (no tools). Risky operations still need approval — this is not legacy Bypass auto-approve — and destructive actions must be double-checked before execution.',
  'executionMode.danger.warningConfirm': 'Enable Danger',
  'executionMode.danger.warningCancel': 'Cancel',
  'goal.label': 'Goal',
  'goal.setTooltip': 'Set a goal for this chat',
  'goal.placeholder': 'Once set, the agent will align each turn with this goal.',
  'goal.title': 'Session Goal',
  'goal.description': 'Set a clear goal for this session to help track progress and scope.',
  'goal.inputPlaceholder': 'Enter the goal you want to achieve in this conversation...',
  'goal.save': 'Save Goal',
  'goal.clear': 'Clear Goal',
  'goal.saveSuccess': 'Session goal updated successfully',
  'goal.clearSuccess': 'Session goal cleared',
  'goal.active': 'Current Goal',
  'goal.panelTitle': 'Session Goal',
  'goal.panelDescription': 'Set a durable objective for this chat and trace progress each turn (Codex /goal-inspired).',
  'goal.status.active': 'Active',
  'goal.status.paused': 'Paused',
  'goal.status.completed': 'Completed',
  'goal.status.restricted': 'Goal restricted',
  'goal.status.idle': 'Not set',
  'goal.trace': 'Goal trace',
  'goal.traceEmpty': 'Send messages to record turn-by-turn progress toward the goal.',
  'goal.continue': 'Continue',
  'goal.pause': 'Pause',
  'goal.resume': 'Resume',
  'goal.edit': 'Edit',
  'goal.markComplete': 'Mark complete',
  'goal.cancelEdit': 'Cancel edit',
  'goal.status.budgetLimited': 'Budget limited',
  'goal.autoContinue': 'Auto-continue',
  'goal.autoContinueOn': 'On',
  'goal.autoContinueOff': 'Off',
  'goal.maxTurns': 'Max turns',
  'goal.maxTokens': 'Token budget',
  'goal.budgetUsage': 'Used {turns}/{maxTurns} turns · {tokens}/{maxTokens} tokens',
  'goal.lastEvaluation': 'Latest evaluation',
  'goal.completedToast': 'Session goal reached',
  'goal.budgetLimitedToast': 'Goal budget exhausted — extend budget to resume',
  'goal.blockedToast': 'Goal blocked — auto-paused for your input',
  'goal.clarify.open': 'Clarify goal',
  'goal.clarify.eyebrow': 'Goal Clarify',
  'goal.clarify.title': 'Clarify your session goal',
  'goal.clarify.subtitle': 'Converge the goal through Q&A and generate success criteria plus an ASCII preview.',
  'goal.clarify.emptyState': 'Start with one sentence about what you want to achieve in this chat.',
  'goal.clarify.waiting': 'Structured goal and ASCII preview will appear here.',
  'goal.clarify.apply': 'Apply to session goal',
  'goal.clarify.applied': 'Clarified goal applied to this session',
  ...
  'workflow.goalPreflight.openButton': 'Clarify Goal',
  'workflow.goalPreflight.eyebrow': 'Goal Preflight',
  'workflow.goalPreflight.title': 'Clarify your goal with Pipi',
  'workflow.goalPreflight.subtitle': 'Describe the goal in one sentence — the clarifier will ask short follow-up questions and produce a runnable Goal with success criteria.',
  'workflow.goalPreflight.emptyState': 'Start with a one-sentence description of what you want to accomplish. Pipi will ask follow-up questions and turn it into a runnable Goal.',
  'workflow.goalPreflight.cardEyebrow': 'Confirm Final Goal',
  'workflow.goalPreflight.confirmTitle': 'Confirm Final Goal',
  'workflow.goalPreflight.progressIdle': 'Pipi is waiting for you to start the conversation.',
  'workflow.goalPreflight.progressStreaming': 'Pipi is drafting the goal…',
  'workflow.goalPreflight.parseFailed': 'Could not parse the structured result. You can keep chatting or fill the form manually.',
  'workflow.goalPreflight.quickStart.login': 'Build a modern login UI',
  'workflow.goalPreflight.quickStart.loginDraft': 'I want a modern login page with email+password, forgot-password flow, and a sign-up entry point.',
  'workflow.goalPreflight.quickStart.refactor': 'Refactor a function with tests',
  'workflow.goalPreflight.quickStart.refactorDraft': 'Refactor a complex function in the current module into smaller units, and add unit and regression tests.',
  'workflow.goalPreflight.quickStart.research': 'Design an automated research workflow',
  'workflow.goalPreflight.quickStart.researchDraft': 'Design an automated research workflow that pulls papers, tracks baselines, iterates experiments, and logs metrics.',
  'workflow.goalPreflight.askMoreAutoPrompt': 'Please ask one or two more focused follow-up questions based on the existing draft — do not return JSON yet.',
  'workflow.goalPreflight.readyEyebrow': 'Goal is ready',
  'workflow.goalPreflight.readinessLabel': 'Readiness',
  'workflow.goalPreflight.finalGoal': 'Final Goal',
  'workflow.goalPreflight.successCriteria': 'Success Criteria',
  'workflow.goalPreflight.assumptions': 'Assumptions',
  'workflow.goalPreflight.openQuestions': 'Open Questions',
  'workflow.goalPreflight.suggestedAgents': 'Suggested Agents',
  'workflow.goalPreflight.topologyNote': 'This will only apply the Goal and Success Criteria — it will not change the workflow topology.',
  'workflow.goalPreflight.createSuggestedAgents': 'Create suggested A→B→C preset',
  'workflow.goalPreflight.asciiPreview': 'ASCII Preview',
  'workflow.goalPreflight.asciiAriaLabel': 'ASCII preview',
  'workflow.goalPreflight.asciiEmpty': 'No ASCII preview',
  'workflow.goalPreflight.risks': 'Risks',
  'workflow.goalPreflight.serializedPreview': 'Saved as',
  'workflow.goalPreflight.applyAndStart': 'Apply & Start',
  'workflow.goalPreflight.applyOnly': 'Apply only',
  'workflow.goalPreflight.askMore': 'Ask more',
  'workflow.goalPreflight.editManually': 'Edit manually',
  'workflow.goalPreflight.appliedNote': 'Applied to the current workflow Goal and success criteria.',
  'workflow.goalPreflight.appliedAndStartedNote': 'Applied and triggered a workflow run.',
  'workflow.goalPreflight.appliedToast': 'Goal applied to current workflow',
  'workflow.goalPreflight.cannotStartInvalid': 'Current workflow configuration is invalid and cannot be started.',
  'workflow.goalPreflight.copy': 'Copy',
  'workflow.goalPreflight.copied': 'Copied',
  'workflow.goalPreflight.copyFailed': 'Copy failed',
  ...
  'browser.surface.externalChromeTitle': 'External Chrome',
  'browser.surface.externalChromeDescription': 'The agent is controlling an external Chrome session via CDP. This panel is not an embedded WebView preview.',
  'browser.surface.cdpConnected': 'External Chrome connected',
  'browser.surface.cdpDisconnected': 'CDP disconnected',
  'browser.surface.openExternalChrome': 'Show Chrome window',
  'browser.surface.expandConsole': 'Expand console',
  'browser.surface.noEmbeddedSurface': 'Connect Chrome or open the embedded browser to see status here.',
  'browser.surface.externalChromeControllerDescription': 'This is a CDP control console. The live browser is the external Chrome window, not this panel.',
  'browser.surface.currentChromePage': 'Current Chrome page',
  'browser.surface.connectionHealth': 'Connection health',
  'browser.surface.launchMode': 'Launch mode',
  'browser.surface.agentStatus': 'Agent status',
  'browser.surface.latestSnapshot': 'Latest snapshot',
  'browser.surface.refreshCdpStatus': 'Refresh CDP status',
  'browser.surface.noChromePage': 'No page observed yet',
  'browser.surface.noChromePageTitle': 'External Chrome is connected',
  'browser.surface.noChromePageDescription': 'Open a page in Chrome, or enter a target URL below before running a task.',
  'browser.surface.readyTitle': 'Chrome page observed',
  'browser.surface.readyDescription': 'The agent can use the current external Chrome page as task context.',
  'browser.surface.targetReadyTitle': 'Target URL ready',
  'browser.surface.targetReadyDescription': 'The task will start by navigating external Chrome to the target URL.',
  'browser.surface.enterTargetUrlFirst': 'Enter a target URL first',
  'browser.surface.hidePanel': 'Hide browser panel',
  'browser.surface.externalChromeConnected': 'External Chrome connected',
  'browser.surface.externalChromeDisconnected': 'External Chrome disconnected',
  'browser.surface.currentCdpUrl': 'Current CDP URL',
  'browser.surface.lastCdpTask': 'Last CDP task',
  'browser.surface.cdpTaskFailed': 'CDP task failed',
  'browser.surface.cdpTaskFailedDescription': 'The latest CDP action failed. Review the error below, resync state, or take over manually.',
  'browser.surface.resyncCdpState': 'Resync CDP state',
  'browser.surface.noCdpSession': 'No active CDP session. Connect external Chrome to continue.',
  'browser.surface.navigate': 'Navigate',
  'browser.surface.navigating': 'Navigating...',
  'browser.surface.navigateFailed': 'Navigation failed',
  ...
  'browser.doNotOperate': 'Agent is controlling the browser — please do not click or scroll',
...
`,
  ...
  // Chat Input
  'chat.input.filesAddedToSession': '{count} context files added to this session',
  'chat.input.filesImported': '{count} context files imported',
  'chat.input.filesCount': '{count} context files',
  'chat.input.dragFilesHere': 'Drag files here as context',
  'chat.input.removeFile': 'Remove file',
  'chat.input.confirmImportFiles': 'Add {count} context files',
  ...
  'chat.input.contextFilesHeader': 'Add as context files',
  ...
  'sidebar.openAccountPicker': 'Switch account / model',
  'sidebar.accountPickerLabel': 'Accounts & models',
  'sidebar.manageAccountsInSettings': 'Manage in Settings…',
  ...
  'browser.authRequiredBeforeAgent': 'This page requires authentication. Please sign in before starting the browser agent.',
  'browser.surfaceMismatchBeforeAgent': 'The browser preview page and CDP-controlled page do not match. Sync or refresh the target page before starting the agent.',
  ...
  'browserAgent.approval.title': 'Confirm browser action',
  'browserAgent.approval.description': 'The agent wants to perform a sensitive browser action.',
  'browserAgent.approval.allow': 'Allow',
  'browserAgent.approval.deny': 'Deny',
  'browserAgent.approval.allowed': 'Browser action approved',
  'browserAgent.approval.denied': 'Browser action denied',
  'browserAgent.log.observeOnlyModeActive': 'Observe-only mode is enabled; mutating browser actions are blocked.',
  'browserAgent.log.authRequiredBeforeAgent': 'Authentication required ({authState}); browser agent was not started.',
  'browserAgent.log.surfaceMismatchBeforeAgent': 'Preview surface and CDP surface do not match; browser agent was not started.',
  'browserAgent.log.surfaceCdpUrlUnavailable': 'Could not read the CDP-controlled page URL; browser agent was not started.',
