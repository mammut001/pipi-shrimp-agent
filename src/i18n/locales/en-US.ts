...
const enUS: TranslationKeys = {
  ...
  'common.hide': 'Hide',
  'common.show': 'Show',
  'common.hideRightPanel': 'Hide right panel',
  'common.showRightPanel': 'Show right panel',
  ...
  'autoresearch.manual.action.envCheckFailed': 'Environment check failed. Fix the issue below and run the check again.',
  'autoresearch.manual.start': 'Start AutoResearch',
  'autoresearch.manual.action.openProviderConfig': 'Open Model Config',
  'autoresearch.bootstrap.log.init': '[SYSTEM] Initializing AutoResearch Bootstrap Setup...',
  'autoresearch.bootstrap.log.spawning': 'Spawning Headless Research Agent...',
  'autoresearch.bootstrap.log.stopped': '[SYSTEM] Bootstrap stopped by user.',
  'autoresearch.bootstrap.log.executing': '[TOOL CALL] Executing: {name}',
  'autoresearch.bootstrap.log.completed': '[TOOL RESULT] Completed {name} in {duration}ms.',
  'autoresearch.bootstrap.log.failed': '[TOOL RESULT] FAILED: {name} — {reason} ({duration}ms)',
  'autoresearch.bootstrap.log.blocked': '[TOOL RESULT] BLOCKED: {name} — {reason} ({duration}ms)',
  'autoresearch.bootstrap.log.streaming': 'Streaming logs...',
  'autoresearch.bootstrap.log.initializing': 'Initializing bootstrap process...',
  'autoresearch.bootstrap.log.finished': 'Finished',
  'autoresearch.bootstrap.log.incomplete': 'Incomplete',
  'autoresearch.bootstrap.log.finalizeNudge': '[SYSTEM] bootstrap_finalize missing after first turn — running finalize nudge turn...',
  'autoresearch.bootstrap.log.finalizing': 'Finalize-nudge headless turn (must call bootstrap_finalize)...',
  'autoresearch.bootstrap.log.agentCompleted': '[SYSTEM] Headless Research Agent completed successfully.',
  ...
  'executionMode.upgrade.body.browser': 'Ask mode cannot use the browser or run tools. Switch to Agent to continue, or choose Bypass if you want fewer confirmations.',
  'executionMode.upgrade.body.workspace': 'Ask mode cannot read project files or run tools. Switch to Agent to continue with your request.',
  'executionMode.upgrade.body.general': 'Ask mode cannot run commands or tools. Switch to Agent to continue, or choose Bypass if you want fewer confirmations.',
  'executionMode.upgrade.agentButton': 'Switch to Agent & continue',
  'executionMode.upgrade.bypassButton': 'Switch to Bypass',
  'executionMode.upgrade.cancel': 'Cancel',
  'executionMode.upgrade.switchedToAgent': 'Switched to Agent mode. Continuing…',
  'executionMode.upgrade.switchedToBypass': 'Switched to Bypass mode. Continuing…',
  ...
  'executionMode.bypass.label': 'Bypass',
  'executionMode.bypass.description': 'Minimal approval. Tools run with little or no confirmation. Use only when you fully trust the request.',
  'executionMode.bypass.warningTitle': 'Enable Bypass?',
  'executionMode.bypass.warningBody': 'Bypass mode runs tool calls with minimal confirmation. Destructive commands and irreversible actions may execute without a final prompt. Only enable this for requests you fully trust.',
  'executionMode.bypass.warningConfirm': 'Enable Bypass',
  ...
  'goal.emptyWarning': 'Goal objective cannot be empty',
  'goal.saveSuccess': 'Session goal updated successfully',
  'goal.clearSuccess': 'Session goal cleared',
  'tool.noProjectFolder.message': 'No Project Folder is bound to this session. Please select a Project Folder before reading, writing, or executing commands.',
  'tool.noProjectFolder.action': 'Select Project Folder',
  'tool.noProjectFolder.noOpNotice': '(No file or command operation was performed)',
