...
describe('i18n key parity', () => {
  ...
  it('en-US translations for new workspace/context copy are non-empty', () => {
    ...
    const requiredKeys: Keys[] = [
      ...
      'chat.noProjectFolderHint',
      'chat.selectProjectFolderDialog',
      'chat.folderDialogBusy',
      'chat.folderDialogFailed',
      'chat.pipiOutputFolder',
      'chat.pipiOutputFolderTooltip',
      'chat.setPipiOutputFolder',
      'chat.noPipiOutputFolderHint',
      'chat.selectPipiOutputFolderDialog',
      'chat.openPipiOutputFolder',
      'chat.contextFiles',
