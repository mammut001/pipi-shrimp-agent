...
const zhCN: TranslationKeys = {
  ...
  'autoresearch.tabs.ariaLabel': '配置模式',
  'autoresearch.tabs.selfImprove': '自我改进',
  'autoresearch.tabs.selfImproveSubtitle': '分析代码库并通过验证命令提出修复方案。',
  'autoresearch.mode.mlExperiment': 'ML 实验',
  'autoresearch.mode.selfImprove': '仓库自我改进',
  'autoresearch.preset.fast': '快速',
  'autoresearch.preset.standard': '标准',
  'autoresearch.preset.full': '完整',
  'autoresearch.preset.custom': '自定义',
  'autoresearch.preset.fastDesc': '仅构建检查',
  'autoresearch.preset.standardDesc': '构建 + 测试 + 类型检查',
  'autoresearch.preset.fullDesc': '构建 + 测试 + 类型检查 + Lint',
  'autoresearch.preset.customDesc': '自定义命令',
  'autoresearch.verificationCommands': '验证命令',
  'autoresearch.addCommand': '添加命令',
  'autoresearch.removeCommand': '移除',
  'autoresearch.atLeastOneCommand': '自我改进模式至少需要一条验证命令。',
  ...
  'autoresearch.selfImproveRepoPlaceholder': '要改进的仓库路径（例如 ~/projects/my-app）',
  'autoresearch.selfImproveRepoField': '要改进的仓库',
  'autoresearch.selfImproveWorkdirHint': '工作目录存放运行产物，仓库路径是用于分析改进的代码库。',
  'autoresearch.selfImproveCardGoal': '要改进的仓库',
  'autoresearch.selfImproveInfo': '自我改进模式会分析代码库中的问题并提出修复方案，验证命令（构建、测试、类型检查）将作为评估信号替代 ML 指标。',
  ...
  'token.noData': '暂无数据',
  'token.input': '输入',
  'token.totalRequests': '总请求数',
  'token.realConsumed': '真实消耗',
  'token.newInput': '新增输入',
  'token.cacheHit': '缓存命中',
  'token.cacheHitRate': '缓存命中率',
  'token.savedByCache': '缓存节省',
  'token.cacheBreakdown': '缓存细分',
