...
const enUS: TranslationKeys = {
  ...
  'executionMode.bypass.warningBody': 'Danger mode can use the full tool surface. Risky operations still keep approval gates, and destructive actions must be double-checked before execution.',
  ...
  'executionMode.danger.warningBody': 'Danger mode can use the full tool surface. Risky operations still keep approval gates, and destructive actions must be double-checked before execution.',
