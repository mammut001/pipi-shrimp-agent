...
const enUS: TranslationKeys = {
  ...
  'executionMode.ask.description': 'Chat and edit files. Tool calls and shell commands always ask for confirmation.',
  ...
  'executionMode.multitask.label': 'Multitask',
  'executionMode.multitask.description': 'Long-running, multi-step goal-driven mode.',
  'executionMode.multitask.experimentalNote': 'Limited: multi-agent routing is not wired; runs as Agent with multi-step prompt.',
