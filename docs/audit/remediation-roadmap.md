...
| **Architecture** | AG-01/02/03/04/06/08/09/13/15 **fixed** (all ≤800 LOC on main 2026-09-24). Still open (under 800 hard limit but split-soon 500–800 / component >500 — no new features before split): AG-05 `browserAgentStore.ts` (606), AG-07 `nativeBrowserAgent.ts` (757), AG-10 `web.rs` (514), AG-11 `workflowStore.ts` (712), AG-12 `chatAdapter.ts` (762), AG-14 `Settings.tsx` (729, >500 component) |
...
| AG-14 | `src/pages/Settings.tsx` | 729 | Extract provider panels — open; under 800 but >500 component threshold (live 2026-09-24) | Yes — component >500 (also split-soon 500–800): no new features before split | Yes |
...
| **Architecture governance lane (I)** | 20 — 14 fixed, 6 open |
