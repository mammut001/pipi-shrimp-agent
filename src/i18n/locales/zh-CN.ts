...
const zhCN: TranslationKeys = {
  ...
  'chat.changeWorkDirectory': '更改工作区文件夹',
  'chat.removeWorkDirectory': '移除工作区文件夹',
  'chat.binding': '设置中...',
  'chat.workspaceFolder': '工作区',
  ...
  'chat.contextFileSetAsWorkspace': '是否将所在目录设为工作区？',
  'chat.useAsWorkspace': '设为工作区',
  'chat.addImage': '添加图片',
  ...
  'executionMode.ask.label': '问',
  'executionMode.ask.description': '聊天和编辑文件。工具调用和 shell 命令始终需要确认。',
  ...
  'executionMode.multitask.label': '多任务',
  'executionMode.multitask.description': '长时间、多步骤、目标驱动的模式。',
  'executionMode.multitask.experimentalNote': '功能有限：未接入真正的多 agent 路由；当前以 Agent 模式配合多步提示运行。',
