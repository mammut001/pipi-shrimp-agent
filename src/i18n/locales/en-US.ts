...
const enUS: TranslationKeys = {
  ...
  'chat.changeWorkDirectory': 'Change workspace folder',
  'chat.removeWorkDirectory': 'Remove workspace folder',
  'chat.binding': 'Setting up...',
  'chat.workspaceFolder': 'Workspace',
  'chat.workspaceFolderTooltip': 'Commands, file edits, memory, and generated docs are stored here.',
  'chat.setWorkspaceFolder': 'Set workspace folder',
  'chat.noWorkspaceHint': 'No workspace folder set — some tools may not run until you pick one.',
  ...
  'chat.contextFileInsideWorkspace': 'Inside workspace',
  'chat.contextFileSetAsWorkspace': 'Set parent folder as workspace?',
  'chat.useAsWorkspace': 'Use as workspace',
